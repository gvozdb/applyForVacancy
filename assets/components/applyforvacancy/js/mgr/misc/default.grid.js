applyForVacancy.grid.Default = function (config) {
    config = config || {};
        ...
        viewConfig: {
            ...
            getRowClass: function (rec) {
                ...
                if (rec.data['active'] != undefined && rec.data['active'] == 0) {
                    cls.push('afv-grid__row_disabled');
                }
                return cls.join(' ');
            },
        },
        cls: config['cls'] || 'main-wrapper afv-grid',
        paging: true,
        remoteSort: true,
        autoHeight: true,
    });
    applyForVacancy.grid.Default.superclass.constructor.call(this, config);
...
Ext.extend(applyForVacancy.grid.Default, MODx.grid.Grid, {
    ...
    getMenu: function (grid, rowIndex) {
        ...
        var menu = applyForVacancy.utils.getMenu(row.data['actions'], this, ids);
...
Ext.reg('afv-grid-default', applyForVacancy.grid.Default);