...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = MODX_CORE_PATH . 'components/applyforvacancy/model/';
            $modx->addPackage('applyforvacancy', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = $modelPath . 'schema/applyforvacancy.mysql.schema.xml';
